...
class BeiJing:
    ...
    def start(self):
        ...
        while True:
            ...
            text_obj = font_obj.render("按ENTER开始,ESC退出", 1, (255, 255, 255))
            text_obj2 = font_obj2.render("全民打飞机", 1, (0, 255, 0))
    ...
    def die(self):
        ...
        while True:
            ...
            text_obj2 = font_obj2.render("你个菜逼", 1, (0, 255, 0))
            text_rect = text_obj.get_rect(centerx=260, centery=380)
...
def main():
    ...
    bigbulletnum_img = pygame.image.load("res/bullet_14.png")
    ...
    bj_circulation = BjCri("res/img_bg_level_1.jpg", 0, 0, 500, 700)
    for _ in range(4):
    ...
    # 设置窗口标题
    pygame.display.set_caption("全民打飞机")
    pygame.mixer.music.play(-1)
    # 设置窗口图标
